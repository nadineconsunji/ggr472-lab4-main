...
Raw GEOJson data files can be found in the "Data" folder. These were sourced from the City of Toronto's Open Data Portal, with the collisions data being derived from a previous version of the following source and edited for use in the lab: https://open.toronto.ca/dataset/motor-vehicle-collisions-involving-killed-or-seriously-injured-persons/ 
